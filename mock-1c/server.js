...
<p>Измените оценки здесь. Изменения попадут в личный кабинет автоматически при следующей синхронизации бэкенда (каждые 10 минут) или после его перезапуска. Кнопка «Обновить» в личном кабинете только перечитывает уже сохранённые данные — синхронизацию с 1С она не запускает.</p>
